...
import 'react'
import 'react-dom'
import 'react-d3-map-choropleth'

//D3js React example - the only one available
/* does not work because requires topojson not geojson*/
...
(function() {
  ...
  var topodata = require('json!./SA2Masterfile.json');
